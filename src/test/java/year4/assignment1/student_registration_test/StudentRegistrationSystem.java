...
public class StudentRegistrationSystem extends TestCase {
	...
	public void testRegSystem (){
    	...
    	//Assert
    	assertEquals(2, courses.size()); //number of courses
    	assertEquals(2, itModules.size()); //Number of IT modules
    	assertEquals(2, engModules.size()); //Number of Engineering modules
    	assertEquals(3, module3.getStudents().size()); //Number of students in Engineering module
    	assertEquals(2, module1.getStudents().size()); //Number of students in IT module
    }
	
	private void print(List<Course> courses){
